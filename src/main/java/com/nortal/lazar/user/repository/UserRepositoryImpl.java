...
//		Query query = em.createQuery("select password from UserEntity where username=:username");
...
//		
//		User user = new User(firstName, lastName, phone, agencyID, status, username, password);
//		return user;
//	}
